  ...
  return (
    <div className="flex flex-col min-h-screen w-full font-kumbh text-gray-800 bg-gradient-to-br dark:bg-gray-900">
      <main className="flex-grow w-full max-w-[1440px] mx-auto">
        ...
        {/* Section 1: Header */}
        <header className="w-full flex flex-col lg:flex-row min-h-[400px] md:min-h-[500px] lg:min-h-[620px] xl:min-h-[720px] overflow-hidden">
          <div className="flex-[2.5] bg-[#155e94] text-white dark:bg-blue80 dark:text-cyan-200 px-4 md:px-8 lg:px-12 xl:px-16 py-10 md:py-16 lg:py-24 flex flex-col justify-center z-10">
            <h1 className="mb-4 md:mb-6 text-2xl md:text-3xl lg:text-4xl xl:text-6xl 2xl:text-[5rem] font-extrabold leading-tight text-blue0 dark:text-cyan-200">
               Hello {user ? user.first_name || user.username : 'Guest'}!
            </h1>
            <p className="text-base md:text-lg lg:text-xl xl:text-2xl font-extrabold max-w-xl text-blue-200 dark:text-cyan-200">
          ...
          <div className="flex-[1.5] relative bg-blue0 dark:bg-gray-800 min-h-[220px] md:min-h-[300px]">
            <img
               src={`${process.env.PUBLIC_URL}/ezgif.com-gif-maker.gif`}
               alt="Robot Guide"
               className="absolute right-0 top-1/2 -translate-y-1/2 w-36 md:w-48 lg:w-64 xl:w-80 2xl:w-96 object-contain pointer-events-none"
        ...
        <section className="w-full bg-blue80 dark:bg-blue100 py-16 md:py-24 lg:py-32 xl:py-60 px-4 md:px-6 text-white dark:text-cyan-200">
          <div className="max-w-7xl mx-auto text-center">
            <h2 className="text-2xl md:text-3xl lg:text-4xl xl:text-6xl font-extrabold tracking-tight mb-4 md:mb-6 text-blue0 dark:text-cyan-200">
              Welcome to Codyssey
            </h2>
            <p className="text-xs md:text-sm lg:text-base xl:text-xl text-blue-200 dark:text-cyan-200 max-w-3xl mx-auto leading-relaxed">
              Unlock your potential with expertly curated learning paths that guide you through real-world coding challenges. Track your progress, sharpen your skills, and build projects that matter — all in one seamless platform.
            </p>
          </div>
        </section>
        ...
        <section className="w-full bg-white dark:bg-gray-900">
          <div className="flex flex-col lg:flex-row min-h-[340px] md:min-h-[400px] lg:min-h-[500px] xl:min-h-[600px]">

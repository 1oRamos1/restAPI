...
function ProgressBar({ currentLevel, progressScore }) {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto mb-12">
      ...
      <div className="flex justify-between mb-3">
        {LEVELS.map((l, idx) => (
          <div key={l.key} className="flex flex-col items-center gap-1" style={{ width: '33%' }}>
            ...
            <span className={`text-xs font-bold ${idx === safeIdx ? l.textColor : 'text-gray-400 dark:text-cyan-700'}`}>
              {l.label}
            </span>
          </div>
        ))}
      ...
      {/* Progress track */}
      <div className="relative h-4 bg-gray-200 dark:bg-cyan-800 rounded-full overflow-hidden shadow-inner">

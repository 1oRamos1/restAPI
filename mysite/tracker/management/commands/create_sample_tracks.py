...
class Command(BaseCommand):
    ...
    "c++": [
        ...
        levels = ['beginner', 'advanced', 'master']
        ...
        for lang, categories in languages_categories_tracks.items():
            for cat_data in categories:
                ...
                category, created = Category.objects.get_or_create(name=cat_name, defaults={'language': lang})
                ...
                for track_data in tracks:
                    ...
                    if not created:
                        if track.level != level or track.category != category:
                            track.level = level

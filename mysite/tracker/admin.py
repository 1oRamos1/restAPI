...
class UserLearningTrackAdmin(admin.ModelAdmin):
    list_display = ('id', 'user', 'learning_track', 'start_date', 'last_updated')
...
class TaskAdmin(admin.ModelAdmin):
    list_display = ('id', 'user_learning_track', 'status', 'grade')
    search_fields = ('task', 'user_learning_track__user__username', 'user_learning_track__learning_track__title')
